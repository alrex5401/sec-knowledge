...
if __name__ == "__main__":
    ...
    elif target == "isr-templates":
        convert("isr-templates",
                "供應商資安要求（ISR）範本導覽",
                "供應商／委外廠商資訊安全要求（ISR）合約條款範本：完整版國際／外商風格 ISR、本土採購合約甲乙方版、壽險委外特化版三份範本，涵蓋數據保護、存取控制、加密、稽核與委外資安條款，供資安檢視與合約撰擬參考。",
                "https://blog.angelz13.com/articles/isr-templates.html",
                "本文彙整作者整理之三份供應商資訊安全要求（ISR）範本，供學習與實務參考；範本內容參酌 NIST 網路安全框架、ISO 27001／27701 等公開資安標準及保險業相關法規，實際採用時請依貴機構情況與法律意見調整、條款空格依實際填寫。")
